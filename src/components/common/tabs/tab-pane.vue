<template lang="pug">
  transition(
    v-bind:appear-active-class = 'transition.enterClass'
    v-bind:enter-active-class = 'transition.enterClass'
    v-bind:leave-active-class = 'transition.leaveClass'
    v-bind:name = 'animation'
    appear = '',
    mode = 'out-in'
  )
    div(
      v-bind:aria-hidden = 'hidden'
      v-bind:aria-labelledby = 'label'
