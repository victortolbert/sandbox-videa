<template lang="pug">
  .price-guide-parent
    ui-title Price Guide
    h2.vui-text-heading--label.vui-m-bottom--medium Videa Pricing was last updated on {{ lastUpdated }} at 08:30 AM
    ui-subtitle Use the Price Guide to review your rates and to either accept the Videa rates or override the Videa rates. The price is set prior to avail in the price guide. If you accept the Videa rates, know that Videa updates the rates every Sunday.
    ui-panel
      // Form
